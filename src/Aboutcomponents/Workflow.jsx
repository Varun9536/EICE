...
{
    return (
        <div className="font-manrope mx-auto sm:px-6 px-4 sm:max-w-7xl w-screen sm:py-36 py-44">
            ...
            <div className="flex flex-col items-center justify-center text-center">
                <h1 className="text-bloo font-bold sm:text-3xl text-2xl pb-4">Our Values</h1>
            ...
            <div className="sm:py-16 py-12">
                <div className="flex flex-col items-center justify-center text-center text-blackk">
                    ...
                    <p className="text-neutral-500/90 textxl font-medium text-lg w-3/4">Ensuring clarity and visiblity throughout the development process to enhance collaboration and efficiency. Our workflow is well organized and flexible at its core.</p>
                </div>
                <div className="lg:flex lg:flex-row md:flex md:flex-row flex flex-col sm:pt-24 pt-20 items-center justify-center">
                    <div className="md:w-52 md:h-52 w-11/12 h-52 border-2 border-bloo rounded-lg">
                    ...
                    <div className="lg:p-4 p-1 lg:scale-100 scale-75">
                        <FaArrowRight size={30} className="text-blackk/50 md:rotate-0 rotate-90"/>
                    </div>
                    <div className="md:w-52 md:h-52 w-11/12 h-52 border-2 border-amber-500 rounded-lg">
                        <div className="flex flex-col text-center w-full h-full items-center justify-center">
                    ...
                    <div className="md:w-52 md:h-52 w-11/12 h-52 border-2 border-emerald-400 rounded-lg">
                        <div className="flex flex-col text-center w-full h-full items-center justify-center">
                    ...
                    <div className="md:w-52 md:h-52 w-11/12 h-52 border-2 border-cyan-400 rounded-lg">
                        <div className="flex flex-col text-center w-full h-full items-center justify-center">
                    ...
                    <div className="md:w-52 md:h-52 w-11/12 h-52 border-2 border-rose-400 rounded-lg">
                        <div className="flex flex-col text-center w-full h-full items-center justify-center">
