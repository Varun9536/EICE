      ...
      <div className="sm:max-w-7xl w-screen mx-auto pb-8">
        ...
        <div className="max-w-3xl mx-auto text-center px-8 flex flex-col gap-2">
          ...
          <p className="font-medium text-blackk/60 sm:text-xl text-lg text-justify">
            At EICE Technology, we excel in transforming logistics operations through state-of-the-art technology solutions. Our mission is to provide innovative software that significantly boosts operational efficiency, optimizes supply chain processes, and supports professionals in delivering exceptional logistics services.

            We serve a wide range of sectors within the logistics industry, ensuring compliance with regulatory standards and enhancing transparency across operations. Our solutions are designed to address the unique challenges of the logistics sector, driving improvements in speed, accuracy, and overall performance. Through our expertise, we enable logistics professionals to achieve their goals and exceed client expectations.
          </p>
        </div>
        ...
        <div className="grid px-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6 pb-16">
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">Implement robust WMS platforms to streamline inventory management, optimize storage utilization, and enhance order processing efficiency through automation and real-time tracking..</p>
            </div>
          </div>
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">Develop intelligent transportation management systems that provide real-time tracking, dynamic route optimization, and efficient fleet management to ensure timely and cost-effective deliveries. </p>
            </div>   
          </div>
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">Create automated order processing systems that accelerate order fulfillment, reduce manual errors, and enhance customer satisfaction through seamless integration with e-commerce platforms and ERP systems. </p>
            </div>
          </div>
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">Deploy IoT-enabled solutions for real-time monitoring of assets, predictive maintenance, and enhanced operational efficiency, ensuring the integrity and security of goods throughout the supply chain.</p>
            </div>
          </div>
