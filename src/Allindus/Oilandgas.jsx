    ...
    <div className="">
      <div className="sm:max-w-7xl w-screen mx-auto pb-8">
        ...
        <div className="pt-20 pb-6">
          <h1 className="text-blackk  font-bold text-center text-2xl sm:text-2xl mx-auto md:text-3xl lg:text-[32px] max-w-3xl pb-4">
            Empowering Oil & Gas Operations with Innovative Software Solutions for a Sustainable Future
          </h1>
        </div>
        <div className="grid px-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6 pb-16">
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">We start by identifying your unique challenges and requirements through a thorough analysis to design software solutions tailored for operational efficiency and sustainability.</p>
            </div>
          </div>
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">Our experts design and develop cutting-edge software solutions that integrate advanced technologies to address your exploration, production, and management needs effectively.</p>
            </div>
          </div>
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">We handle the deployment and integration of the software into your existing systems, ensuring a smooth transition and seamless operations from day one. .</p>
            </div>
          </div>
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">We conduct extensive testing to ensure our software solutions meet all functional requirements, regulatory standards, and industry best practices for optimal performance.</p>
            </div>
          </div>
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">We provide detailed training for your team and offer continuous support to address any issues, ensuring that you maximize the benefits of our software solutions</p>
            </div>
          </div>
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">We continuously monitor the software’s performance, gather feedback, and implement updates to optimize efficiency, safety, and sustainability in your oil and gas operations</p>
            </div>
          </div>
