      ...
      <div className="sm:max-w-7xl w-screen mx-auto pb-8">
        ...
        <div className="max-w-3xl mx-auto text-center px-8 flex flex-col gap-2">
          ...
          <p className="font-medium text-blackk/60 sm:text-xl text-lg text-justify">
            ...
            We serve a wide range of sectors within the enterprise industry, ensuring compliance with regulatory standards and enhancing transparency across operations. Our solutions are designed to address the unique challenges of the enterprise sector, driving improvements in productivity, accuracy, and overall performance. Through our expertise, we enable professionals to achieve their goals and exceed client expectations.
          </p>
        </div>
        ...
        <div className="grid px-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6 pb-16">
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">Implement robust ERP platforms to streamline inventory management, optimize resource utilization, and enhance process efficiency through automation and real-time tracking..</p>
            </div>
          </div>
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">Develop intelligent BPM systems that provide real-time tracking, dynamic process optimization, and efficient management to ensure timely and cost-effective operations.</p>
            </div>
          </div>
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">Offer comprehensive business visibility solutions, integrating advanced analytics for predictive insights, demand forecasting, and improved decision-making across the enterprise network.</p>
            </div>
          </div>
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">Create automated workflow systems that accelerate task completion, reduce manual errors, and enhance employee satisfaction through seamless integration with enterprise platforms and ERP systems.</p>
            </div>
          </div>
          ...
          <div className="group  p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200">
            ...
            <div className="pt-6 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg px-4">Deploy IoT-enabled solutions for real-time monitoring of assets, predictive maintenance, and enhanced operational efficiency, ensuring the integrity and security of data throughout the enterprise..</p>
            </div>
          </div>
