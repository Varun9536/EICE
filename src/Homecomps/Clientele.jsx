...
function Clientele() {
    return (
        <div className="bg-map bg-cover bg-blend-overlay bg-white/75 shadow-sm shadow-blackk/20 font-manrope text-blackk py-16 sm:py-20 md:py-24 lg:py-32 xl:py-40 2xl:py-44 px-4 sm:px-6 lg:px-8">
