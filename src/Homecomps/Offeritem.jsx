    ...
    return (
        <Link to={link} className="sm:w-full w-screen block pb-4">
            <div className="lg:px-0 px-4 w-full ">
                <div className={`p-5 lg:h-[300px] h-[350px] grid grid-cols-5 gap-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-transparent hover:border-gray-200`}>
                    ...
                    <div className="col-span-4">
                        ...
                        <h1 className="font-medium text-blackk/60 sm:text-xl text-lg text-justify">{fliptext}</h1>
                    </div>
                </div>
            </div>
        </Link>
