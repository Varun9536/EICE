            ...
            <div className="max-w-7xl mx-auto ">
                <div className=" grid grid-cols-2 lg:grid-cols-3 gap-8 items-center">
                    <div className="col-span-2 text-center px-4 lg:text-left order-2 lg:order-1">
                        <h1 className=" font-base  text-2xl sm:text-3xl lg:text-4xl xl:text-5xl leading-snug pb-8">
                           Happy chills, contentment, gratification, fruition. <span className="text-bloo font-semibold">Check our detailed case studies</span>
                        </h1>
