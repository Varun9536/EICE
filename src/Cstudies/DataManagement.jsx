        ...
        <div className="text-justify">
            <div className="max-w-7xl text-justify mx-auto px-4 2xl:pt-12 pt-32">
                <div className="w-full">
                    <h1 className="text-bloo font-bold text-center text-xl sm:text-xl lg:text-2xl  py-2">E&P Data Management on GIS</h1>
                    ...
                    <div className="w-full max-w-7xl mx-auto items-center justify-center pt-8 pb-4 grid grid-cols-2 gap-4"><img src={datamgmt1} alt="" className="w-full h-full object-fit"/><img src={datamgmt2} alt="" className="w-full h-full object-fit"/></div>
                </div>
