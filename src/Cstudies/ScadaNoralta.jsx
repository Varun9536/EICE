        ...
        <div className="text-justify">
            <div className="max-w-7xl text-justify mx-auto px-4 2xl:pt-12 pt-32">
                <div className="w-full">
                    <h1 className="text-bloo font-bold text-center text-xl sm:text-xl lg:text-2xl  py-2">Engineering Integration with SCADA</h1>
                    <h2 className="text-blackk  font-bold text-center text-2xl sm:text-2xl mx-auto md:text-3xl lg:text-[32px] max-w-3xl py-1">Development of PLC Information Management System</h2>
                    <p className="font-medium max-w-4xl mx-auto text-justify text-blackk/60 sm:text-xl text-lg pt-4 px-4">Development of PLC Information Management System: A comprehensive solution integrating SCADA data and PLC business logic for efficient management and visualization of gas industry operations.</p>
                    <div className="w-full max-w-7xl mx-auto items-center justify-center pt-8 pb-4 grid grid-cols-1 gap-4"><img src={scadanoralta1} alt="" className="object-fit justify-self-center"/></div>
                </div>
