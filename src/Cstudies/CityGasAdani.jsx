                        ...
                        <div className="p-2 rounded-xl hover:scale-[.99] transition duration-300">
                            <Link to='/CaseStudy-PetroSIM' className="w-1/2 sm:w-1/2 md:w-1/3 lg:w-1/4 p-2 md:p-4">
                                ...
                                <div className="p-3 md:p-4">
                                    ...
                                    <p className="text-gray-600 text-xs sm:text-sm">Product Quality Assurance for Refinery Simulation Tool</p>
                                </div>
                                </div>
                            </Link>
                        </div>
                        <div className="p-2 rounded-xl hover:scale-[.99] transition duration-300">
                            <Link to='/CaseStudy-ReliMonitor' className="w-1/2 sm:w-1/2 md:w-1/3 lg:w-1/4 p-2 md:p-4">
                                ...
                                <div className="p-3 md:p-4">
                                    ...
                                    <p className="text-gray-600 text-xs sm:text-sm">Developed a Real Time Sensor monitoring tool using SCADA</p>
                                </div>
                                </div>
                            </Link>
                        </div>
                        <div className="p-2 rounded-xl hover:scale-[.99] transition duration-300">
                            <Link to='/CaseStudy-EspctQuote' className="w-1/2 sm:w-1/2 md:w-1/3 lg:w-1/4 p-2 md:p-4">
                                ...
                                <div className="p-3 md:p-4">
                                    ...
                                    <p className="text-gray-600 text-xs sm:text-sm">Web Based Sales and Quotation Tool</p>
                                </div>
                                </div>
                            </Link>
                        </div>
