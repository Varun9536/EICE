                ...
                <div className="w-full pb-6">
                    ...
                    <div className="max-w-3xl mx-auto flex flex-col py-4 gap-4">
                        ...
                        <div className="flex gap-4">
                            ...
                            <p className="font-medium text-blackk/60 sm:text-xl text-lg py-2">Alarm management: Developing an efficient system to raise appropriate alarms without overwhelming operators.</p>
                        </div>
                        <div className="flex gap-4">
                            ...
                            <p className="font-medium text-blackk/60 sm:text-xl text-lg py-2">Performance optimization: Balancing system performance with the need for real-time monitoring and analysis.</p>
                        </div>
                        <div className="flex gap-4">
                            ...
                            <p className="font-medium text-blackk/60 sm:text-xl text-lg py-2">Cross-platform compatibility: Extending the application to various well types (ESP, PCP, Gas Lift, Natural flowing wells).</p>
                        </div>
                        <div className="flex gap-4">
                            ...
                            <p className="font-medium text-blackk/60 sm:text-xl text-lg py-2">User adoption: Ensuring the system is user-friendly for operators and engineers across different domains.</p>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="group-hover:scale-[.98] transition duration-200 grid grid-cols-1 gap-3">
                                    ...
                                    <div>
                                        <div className="flex flex-col p-2 text-start justify-end">
                                            ...
                                            We meticulously designed a real-time monitoring system that interfaces with existing SCADA infrastructure. Our focus was on creating a versatile tool that could adapt to various well types and provide actionable insights through data analytics.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="group-hover:scale-[.98] transition duration-200 grid grid-cols-1 gap-3">
                                    ...
                                    <div>
                                        <div className="flex flex-col p-2 text-start justify-end ">
                                            ...
                                            <p className="z-20 font-medium text-blackk/60 sm:text-xl text-lg">
                                            We prioritized real-time data processing, intelligent alarm management, and user-friendly visualizations. By leveraging artificial lift methods calculations and SCADA data analysis, we developed a system that not only monitors but also predicts and alerts on critical issues.    
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="group-hover:scale-[.98] transition duration-200 grid grid-cols-1 gap-3">
                                    ...
                                    <div>
                                        <div className="flex flex-col p-2 text-start">
                                            ...
                                            <p className="z-20 font-medium text-blackk/60 sm:text-xl text-lg">
                                            The RE.LI Monitor tool has revolutionized real-time sensor monitoring for ESPCT, enabling proactive management of well operations. The system's ability to plot performance graphs, send automated alerts, and extend to various well types has significantly improved operational efficiency and reduced downtime.                                            </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="w-full pb-20">
                    ...
                    <div className="max-w-3xl mx-auto flex flex-col py-4 gap-4">
                        <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
                            <h1 className="text-bloo flex items-center justify-center h-full font-bold text-center text-xl sm:text-xl lg:text-2xl  py-2">01</h1>
                            <p className="font-medium text-blackk/60 sm:text-xl text-lg py-2">Developed a real-time sensor monitoring tool (RE.LI Monitor) capable of interfacing with multiple data acquisition systems.</p>
                        </div>
                        <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
                            <h1 className="text-bloo flex items-center justify-center h-full font-bold text-center text-xl sm:text-xl lg:text-2xl  py-2">02</h1>
                            <p className="font-medium text-blackk/60 sm:text-xl text-lg py-2">Implemented an intelligent alarm system that raises appropriate alerts based on SCADA data analysis.</p>
                        </div>
                        <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
                            <h1 className="text-bloo flex items-center justify-center h-full font-bold text-center text-xl sm:text-xl lg:text-2xl  py-2">03</h1>
                            <p className="font-medium text-blackk/60 sm:text-xl text-lg py-2">Created a robust plotting system for visualizing different alarm trends and performance metrics.</p>
                        </div>
                        <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
                            <h1 className="text-bloo flex items-center justify-center h-full font-bold text-center text-xl sm:text-xl lg:text-2xl  py-2">04</h1>
                            <p className="font-medium text-blackk/60 sm:text-xl text-lg py-2">Established an automated email alert system for critical alarms.</p>
                        </div>
                        <div className="flex gap-4 rounded-xl border-2 border-blue-900/60 p-4 shadow-md shadow-blue-900/20">
                            <h1 className="text-bloo flex items-center justify-center h-full font-bold text-center text-xl sm:text-xl lg:text-2xl  py-2">05</h1>
                            <p className="font-medium text-blackk/60 sm:text-xl text-lg py-2">Successfully extended the application's use from ESP wells to PCP, Gas Lift, and Natural flowing wells.</p>
                        </div>
                    </div>
                </div>
            <Footer />
