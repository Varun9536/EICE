...
function Cstdmain()
{
    ...
    return(
        <div className="font-manrope">
            <div className="flex-col text-white font-manrope flex text-center font-bold bg-cstdmain bg-blend-overlay bg-black/75 bg-cover 
            ...
            <div className="2xl:p-0 p-4">
                <div className="2xl:ml-[450px] 2xl:mr-[450px] p-4 pb-16">
                    ...
                    <div className="flex flex-row">
                        ...
                        <div id="slider" className="no-scrollbar flex flex-row gap-12 pt-2 overflow-visible whitespace-nowrap overflow-x-scroll scroll scroll-smooth
                                                    w-full h-full
                                                    ">
                            <div className="cursor-pointer w-[500px] flex flex-col justify-center 2xl:scale-100">
                ...
                <div className="2xl:ml-[450px] 2xl:mr-[450px] p-4 pb-16">
                    <h1 className="font-semibold 2xl:text-3xl">OIL AND GAS INDUSTRY</h1>
                    <div className="shadow-sm shadow-blackk/10 pt-1"></div>
                    {/* <div className="grid grid-cols-3 gap-12 pt-2"> */}
                    <div className="flex flex-row">
                        <div className="flex items-center cursor-pointer opacity-50 hover:opacity-100" ><MdChevronLeft size={40} onClick={slideLeft} /></div>
                ...
                <div className="2xl:ml-[450px] 2xl:mr-[450px] p-4 pb-16">
                    <h1 className="font-semibold 2xl:text-3xl">HEALTHCARE INDUSTRY</h1>
                    <div className="shadow-sm shadow-blackk/10 pt-1"></div>
                    {/* <div className="grid grid-cols-3 gap-12 pt-2"> */}
                    <div className="flex flex-row">
                        <div className="flex items-center cursor-pointer opacity-50 hover:opacity-100" ><MdChevronLeft size={40} onClick={slideLeft} /></div>
