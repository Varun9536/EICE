import { FaLightbulb, FaChartLine, FaCloudUploadAlt, FaShieldAlt, FaRobot, FaProjectDiagram } from "react-icons/fa";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div>
              <p className="font-medium text-blackk/60 sm:text-xl text-lg text-justify">
                In today's rapidly evolving digital landscape, leveraging the right technologies is crucial for 
        ...
        <div className="grid px-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6 pt-8">
          <div className="group p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
            ...
            <div className="pt-2 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg ">
                We help you develop a comprehensive technology strategy aligned with your business goals, 
                creating a clear roadmap for digital transformation and innovation initiatives.
              </p>
            </div>
          </div>
          <div className="group p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
            ...
            <div className="pt-2 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg ">
                We guide you through the digital transformation process, helping you leverage emerging 
                technologies to improve operational efficiency, enhance customer experiences, and 
          ...
          <div className="group p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
            ...
            <div className="pt-2 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg ">
                We provide expert guidance on cloud adoption strategies, helping you choose the right 
                cloud platforms and services, and manage the migration of your applications and infrastructure 
                to the cloud.
              </p>
            </div>
          </div>
          <div className="group p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
            ...
            <div className="pt-2 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg ">
                We assess your cybersecurity posture, identify vulnerabilities, and develop comprehensive 
                security strategies to protect your digital assets and ensure compliance with industry 
                regulations.
              </p>
            </div>
          </div>
          <div className="group p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
            ...
            <div className="pt-2 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg ">
                We help you harness the power of AI and machine learning technologies, identifying 
                use cases, developing proof-of-concepts, and implementing AI-driven solutions 
          ...
          <div className="group p-8 bg-white rounded-md overflow-hidden shadow-sm shadow-white transition-shadow duration-300 hover:shadow-lg hover:shadow-blackk/10 border border-white border-transparent hover:border-gray-200 ">
            ...
            <div className="pt-2 h-full text-left">
              ...
              <p className="font-medium text-blackk/60 sm:text-xl text-lg ">
                We analyze your current IT infrastructure and provide recommendations for optimization, 
                helping you improve performance, reduce costs, and enhance scalability through 
