...
const technologies = {
  mobile: [
    ...
    { name: "React", icon: "react-icon", link: "services-reactnative" },
  ],
};
...
function Android()
{
        ...
        <div className="relative font-manrope mx-auto sm:max-w-7xl w-screen ">
            ...
            <div className="flex lg:flex-row flex-col px-4 py-20 items-center">
                <div className="w-full">
                    <h1 className="text-blackk font-bold sm:text-6xl text-4xl sm:leading-tight leading-snug">Android Application Development</h1>
    ...
    <div className="max-w-7xl mx-auto py-16 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        <h1 className="text-blackk font-bold text-3xl sm:text-4xl lg:text-5xl leading-tight mb-6">
            Comprehensive <span className="text-bloo">Android App Development</span> Services: Unlocking Your Mobile Potential
        </h1>
        </div>
        <div>
            <p className="font-medium text-base sm:text-lg text-justify">
            In today's mobile-first world, having a robust and user-friendly Android app is crucial for businesses to stay competitive and engage their audience effectively. At EICE Technology we offer a comprehensive suite of Android app development services designed to meet the diverse needs of businesses across various industries. 
            </p>
            <p className="font-medium text-base sm:text-lg text-justify mt-4">
            Our team of experienced developers, designers, and strategists work collaboratively to deliver innovative and high-quality Android applications that drive business growth and enhance user experiences.
            </p>
        </div>
    </div>


    <h1 className="text-bloo font-bold sm:text-3xl text-2xl text-center pt-20">Android Services</h1>
            <h2 className="text-blackk font-bold sm:text-4xl text-3xl sm:leading-tight leading-snug text-center py-2">Our Core Competencies in Android App Development</h2>
    ...
    <div className="w-full h-full border-2 border-bloo rounded-lg p-8 py-16 flex flex-col items-center justify-center">
        ...
        <div className="pt-6 h-full text-center">
            <h1 className="font-semibold pb-2 text-xl">Android Application Consulting</h1>
    ...
    <div className="w-full h-full border-2 border-bloo rounded-lg p-8 py-16 flex flex-col items-center justify-center">
        ...
        <div className="pt-6 h-full text-center">
            <h1 className="font-semibold pb-2 text-xl">Android App UI/UX Design</h1>
    ...
    <div className="w-full h-full border-2 border-bloo rounded-lg p-8 py-16 flex flex-col items-center justify-center">
        ...
        <div className="pt-6 h-full text-center">
            <h1 className="font-semibold pb-2 text-xl">Android Wearable App Development</h1>
            <p>We develop specialized Android apps for wearables like smartwatches and fitness trackers, offering valuable insights and seamless interactions to enhance the user experience.</p>    
        </div>
    </div>
    <div className="w-full h-full border-2 border-bloo rounded-lg p-8 py-16 flex flex-col items-center justify-center">
        <div className="h-1/2 rounded-full ">
        ...
        <div className="pt-6 h-full text-center">
            <h1 className="font-semibold pb-2 text-xl">Android App Testing</h1>
    ...
    <div className="w-full h-full border-2 border-bloo rounded-lg p-8 py-16 flex flex-col items-center justify-center">
        ...
        <div className="pt-6 h-full text-center">
            <h1 className="font-semibold pb-2 text-xl">Android App Upgrade & Porting</h1>
            <p>We deliver Android app upgrade and porting solutions to enhance features, improve performance, and ensure compatibility with different devices and platforms for a smooth and modern user experience.</p>
        </div>
    </div>
    <div className="w-full h-full border-2 border-bloo rounded-lg p-8 py-16 flex flex-col items-center justify-center">
        <div className="h-1/2 rounded-full ">
        ...
        <div className="pt-6 h-full text-center">
            <h1 className="font-semibold pb-2 text-xl">Android App Maintenance</h1>
            <p>We provide expert Android app maintenance, focusing on critical bug fixes, performance optimization, and regular updates to ensure your app remains secure, functional, and current with the latest technology advancements.</p>
        </div>
    </div>
</div>
   
    <div className="pb-32 pt-12">
    <h1 className="text-bloo font-bold sm:text-3xl text-2xl text-center pb-8">Android App Development Technologies We Use</h1>
